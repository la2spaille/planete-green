...
use Engine\Model\HttpClient\HttpClient;
...
class Client
{
     ...
     * Initialize client.
     *
     * @param string $url            Products URL.
     * @param string $consumerKey    Consumer key.
     * @param string $consumerSecret Consumer secret.
     * @param array $options        Options (version, timeout, verify_ssl, oauth_only).
     */
    public function __construct(string $url, string $consumerKey, string $consumerSecret, array $options = [])
    {
